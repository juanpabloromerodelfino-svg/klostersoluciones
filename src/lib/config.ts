export const SITE = {
  ...
  googleMapsEmbed: '', // URL del embed de Google Maps
}
...
export const TESTIMONIALS = [
  ...
  {
    name: 'Carlos R.',
    text: 'Muy profesionales. Me instalaron el sistema de riego y quedaron atentos a cualquier ajuste. Se nota que les importa hacer bien las cosas.',
    rating: 5,
  },
  {
    name: 'Ana P.',
